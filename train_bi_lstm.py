...
def build_parser():
    ...
    # --long-corpus long_corpus.txt --label-corpus label_corpus.txt --check-point-path weight/cp.ckpt --model-hdf5-path weight/model.h5
...
# 实例化定义模型，并编译模型
model, encoder_model, decoder_model = define_models.bi_lstm_model(input_vocab_size, target_vocab_size, latent_dim)
